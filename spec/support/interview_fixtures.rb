  ...
  def cafe_output(overrides = {})
    {
      ...
      "facts" => [ { "slot" => "location", "attribute" => "location", "value" => "渋谷", "source_text" => "渋谷でカフェをやっています", "confidence" => 0.9 },
                   { "slot" => "name", "attribute" => "name", "value" => "渋谷のカフェ", "source_text" => "渋谷でカフェ", "confidence" => 0.85 } ],
      "experiences" => [ { "slot" => "what", "summary" => "自家焙煎のコーヒー", "source_text" => "豆は農園から直接仕入れて自分で焙煎しています", "confidence" => 0.9 } ],
      "goals" => [ { "statement" => "近所の人にもっと来てほしい", "verb" => "来てほしい", "source_text" => "近所の人にもっと来てほしい", "confidence" => 0.9 } ],
